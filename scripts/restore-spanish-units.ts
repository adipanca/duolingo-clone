...
// One-off repair script: an earlier migration accidentally deleted the
// Spanish course's "Unit 1"/"Unit 2" (its units share titles with the
// English course's units, and the delete query wasn't scoped by courseId).
// This restores the original content from scripts/prod.ts, scoped strictly
// to the Spanish course.
...
const main = async () => {
  ...
  if (!course) {
    console.log("Spanish course not found, nothing to restore");
    return;
  }
  ...
  if (existing) {
    console.log("Spanish course already has units, skipping");
    return;
  }

  console.log("Restoring Spanish course units...");
    ...
    for (const lesson of lessons) {
      ...
      for (const challenge of challenges) {
        ...
        if (challenge.order === 4) {
          await db.insert(schema.challengeOptions).values([
            { challengeId: challenge.id, correct: false, text: "la mujer", audioSrc: "/es_woman.mp3" },
            { challengeId: challenge.id, correct: true, text: "el hombre", audioSrc: "/es_man.mp3" },
            { challengeId: challenge.id, correct: false, text: "el chico", audioSrc: "/es_boy.mp3" },
          ]);
        }
        if (challenge.order === 5) {
          await db.insert(schema.challengeOptions).values([
            { challengeId: challenge.id, correct: false, text: "el hombre", imageSrc: "/man.svg", audioSrc: "/es_man.mp3" },
            { challengeId: challenge.id, correct: false, text: "la mujer", imageSrc: "/woman.svg", audioSrc: "/es_woman.mp3" },
            { challengeId: challenge.id, correct: true, text: "el zombie", imageSrc: "/zombie.svg", audioSrc: "/es_zombie.mp3" },
          ]);
        }
        if (challenge.order === 6) {
          await db.insert(schema.challengeOptions).values([
            { challengeId: challenge.id, correct: true, text: "el robot", imageSrc: "/robot.svg", audioSrc: "/es_robot.mp3" },
            { challengeId: challenge.id, correct: false, text: "el zombie", imageSrc: "/zombie.svg", audioSrc: "/es_zombie.mp3" },
            { challengeId: challenge.id, correct: false, text: "el chico", imageSrc: "/boy.svg", audioSrc: "/es_boy.mp3" },
          ]);
        }
        if (challenge.order === 7) {
          await db.insert(schema.challengeOptions).values([
            { challengeId: challenge.id, correct: true, text: "la nina", imageSrc: "/girl.svg", audioSrc: "/es_girl.mp3" },
            { challengeId: challenge.id, correct: false, text: "el zombie", imageSrc: "/zombie.svg", audioSrc: "/es_zombie.mp3" },
            { challengeId: challenge.id, correct: false, text: "el hombre", imageSrc: "/man.svg", audioSrc: "/es_man.mp3" },
          ]);
        }
        if (challenge.order === 8) {
          await db.insert(schema.challengeOptions).values([
            { challengeId: challenge.id, correct: false, text: "la mujer", audioSrc: "/es_woman.mp3" },
            { challengeId: challenge.id, correct: true, text: "el zombie", audioSrc: "/es_zombie.mp3" },
            { challengeId: challenge.id, correct: false, text: "el chico", audioSrc: "/es_boy.mp3" },
          ]);
        }
      }
  ...
  console.log("Spanish course units restored");
};
